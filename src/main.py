...
from src.services.imessage_service import start_imessage_poller, notify
...
async def lifespan(app: FastAPI):
    ...
    scheduler = start_scheduler(settings.reminder_check_interval_minutes, notify_fn=notify)
